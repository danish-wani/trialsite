...
urlpatterns = [
    ...
    path('listOperator/signupOperator/',views.signupOperator, name='signupOperator'),
    path('dashboard/listOperator/deleteOperator/<id>/',views.deleteOperator, name='deleteOperator'),
    path('listOperator/',views.listOperator, name='listOperator'),
    ...
    path('list_trial/deleteTrial/<title>/',views.deleteTrial, name='deleteTrial'),


    # urls for testing purpose
    path('trial_detail/<str:title>/',views.DetailTrial.as_view(),name='trial_detail'),
    path('signup_patient/', views.SignupPatient.as_view(), name='signup_patient'),
